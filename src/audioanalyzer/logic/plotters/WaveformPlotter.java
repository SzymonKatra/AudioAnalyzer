 ...
 * Waveform plotter
 */
public class WaveformPlotter implements IWaveformPlotter {
    ...
    public double getX() {
        return m_targetRectangle.getMinX();
    }

    public double getWidth() {
        return m_targetRectangle.getWidth();
    }

    public double getY() {
        return m_targetRectangle.getMinY();
    }

    public double getHeight() {
        return m_targetRectangle.getHeight();
    }
}
